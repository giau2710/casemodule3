...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    <a class="nav-link scrollto" style="right:10px;position: absolute !important;" href="index">Log out</a>
</div>
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <h1 class="logo"><a href="homelogin">SHOPRICH</a></h1>

        <nav id="navbar" class="navbar">
            <ul>
                <li><a class="nav-link scrollto " href="homelogin">Home</a></li>
